...
from pyspark.sql.functions import explode ,split ,window, concat_ws
...
if __name__ == "__main__":
    ...
    data = spark.readStream.format("socket").option("host", '8.tcp.ngrok.io')\
            .option("multiLine",True)\
            .option("port", 11802).load()
    ...
    query = result.writeStream.queryName("queryParcial") \
                          .outputMode("complete") \
                          .format("console") \
